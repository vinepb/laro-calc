...
export class RoCalculatorComponent implements OnInit, OnDestroy {
  ...
  private initCalcTableColumns() {
    ...
    this.cols = [
      ...
      { field: 'skillMinDamage', header: this.i18nService.t('calculator.compare.skillMin'), default: true },
      { field: 'skillMaxDamage', header: this.i18nService.t('calculator.compare.skillMax'), default: true },
      { field: 'skillDps', header: this.i18nService.t('calculator.compare.dps'), default: true },
      { field: 'skillHitKill', header: this.i18nService.t('calculator.compare.hitKill'), default: true },
      { field: 'skillCriRateToMonster', header: this.i18nService.t('calculator.compare.critRate') },
      ...
      { field: 'accuracy', header: this.i18nService.t('calculator.compare.basicAccuracy') },
      { field: 'totalPene', header: this.i18nService.t('calculator.compare.basicPenetration') },
      { field: 'basicMinDamage', header: this.i18nService.t('calculator.compare.basicMin') },
      { field: 'basicMaxDamage', header: this.i18nService.t('calculator.compare.basicMax') },
      { field: 'criMaxDamage', header: this.i18nService.t('calculator.compare.basicCritDamage') },
      { field: 'criMaxDamage', header: this.i18nService.t('calculator.compare.basicDps') },
      { field: 'basicCriRate', header: this.i18nService.t('calculator.compare.basicCritRate') },
    ];
